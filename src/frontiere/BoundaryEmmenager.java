	...
	private void emmenagerDruide(String nomVisiteur) {
		...
		do{
			...
			if (potionmin>potionmax) {
				System.out.println("Attention Druide, vous vous etes trompé entre le maximum et le minimum");
			}
			
		}while(potionmin>potionmax);
		controlEmmenager.ajouterDuide(nomVisiteur, forcedruide, potionmin, potionmax);
	}
}
